...
void video_confirm_ok_clicked(component *c, void *userdata) {
    ...
    video_menu_confirm_data *local = (video_menu_confirm_data *)userdata;
...
void menu_video_confirm_free(component *c) {
    video_menu_confirm_data *local = (video_menu_confirm_data *)menu_get_userdata(c);
    omf_free(local);
...
component *menu_video_confirm_create(scene *s, settings_video *old_settings) {
    video_menu_confirm_data *local = (video_menu_confirm_data *)calloc(1, sizeof(video_menu_confirm_data));
