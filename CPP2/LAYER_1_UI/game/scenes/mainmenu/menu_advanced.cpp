...
void menu_advanced_done(component *c, void *u) {
    ...
    menu_advanced_local *local = (menu_advanced_local *)menu_get_userdata(c->parent);
...
component *menu_advanced_create(scene *s) {
    ...
    menu_advanced_local *local = (menu_advanced_local *)calloc(1, sizeof(menu_advanced_local));
