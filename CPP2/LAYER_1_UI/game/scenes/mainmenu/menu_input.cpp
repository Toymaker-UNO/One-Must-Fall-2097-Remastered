...
void menu_set_right_keyboard(component *c, void *userdata) {
    menu_input_local *local = (menu_input_local *)menu_get_userdata(c->parent);
...
void menu_input_free(component *c) {
    menu_input_local *local = (menu_input_local *)menu_get_userdata(c);
    omf_free(local);
    menu_set_userdata(c, local);
}

component *menu_input_create(scene *s, int player_id) {
    menu_input_local *local = (menu_input_local *)calloc(1, sizeof(menu_input_local));
