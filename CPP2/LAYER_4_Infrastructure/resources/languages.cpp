...
bool lang_init(void) {
    ...
    language = (sd_language *)omf_calloc(1, sizeof(sd_language));
    ...
    if(language->count == old_language_count) {
        ...
        sd_lang_string *expanded_strings = (sd_lang_string *)malloc(LANG_STR_COUNT * sizeof(sd_lang_string));
        unsigned next = 0;
    ...
    language2 = (sd_language *)omf_calloc(1, sizeof(sd_language));
