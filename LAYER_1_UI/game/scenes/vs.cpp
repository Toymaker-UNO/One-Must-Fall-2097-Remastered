...
static void vs_free(scene *scene) {
    vs_local *local = (vs_local *)scene_get_userdata(scene);
...
void vs_static_tick(scene *scene, int paused) {
    vs_local *local = (vs_local *)scene->userdata;
    if(dialog_is_visible(&local->too_pathetic_dialog)) {
...
static report_card *create_report_card(const fight_stats *fight_stats) {
    char text[256];
    char money[4][16];
    report_card *card = (report_card *)calloc(1, sizeof(report_card));
...
int vs_create(scene *scene) {
    ...
    // Init local data
    vs_local *local = (vs_local *)calloc(1, sizeof(vs_local));
    scene_set_userdata(scene, local);
    game_player *player1 = game_state_get_player(scene->gs, 0);
    game_player *player2 = game_state_get_player(scene->gs, 1);
    ...
    object *player1_har = (object *)calloc(1, sizeof(object));
    ...
    if(player2->pilot) {
        object *player2_har = (object *)calloc(1, sizeof(object));
        ...
        // PLAYER
        object *player1_portrait = (object *)calloc(1, sizeof(object));
        ...
        object *player2_portrait = (object *)calloc(1, sizeof(object));
        ...
        // plug time!!!!!!!111eleven!
        object *plug = (object *)calloc(1, sizeof(object));
    ...
    if(player2->selectable) {
        ...
        object *arena_select = (object *)calloc(1, sizeof(object));
    ...
    object *o_scientist = (object *)calloc(1, sizeof(object));
    ...
    object *o_welder = (object *)calloc(1, sizeof(object));
    ...
    // GANTRIES
    object *o_gantry_a = (object *)calloc(1, sizeof(object));
    ...
    if(player2->pilot) {
        object *o_gantry_b = (object *)calloc(1, sizeof(object));
