...
bool lab_dash_main_photo_left(component *c, void *userdata) {
    dashboard_widgets *dw = (dashboard_widgets *)userdata;
...
bool lab_dash_main_chr_load(component *c, void *userdata) {
    ...
    p1->chr = (sd_chr_file *)omf_calloc(1, sizeof(sd_chr_file));
...
void lab_dash_main_chr_init(component *menu, component *submenu) {
    ...
    dashboard_widgets *dw = (dashboard_widgets *)trnmenu_get_userdata(submenu);
    ...
    dw->index = 0;
    chr = (sd_chr_file *)list_get(dw->savegames, 0);
    p1->pilot = &chr->pilot;
    if(!p1->chr) {
...
component *lab_dash_main_create(scene *s, dashboard_widgets *dw) {
    ...
    if(p1->pilot->photo) {
        ...
        dw->pilot->photo = (sd_sprite *)omf_calloc(1, sizeof(sd_sprite));
...
component *lab_dash_sim_create(scene *s, dashboard_widgets *dw) {
    ...
    surface *sur = (surface *)calloc(sizeof(surface), 1);
