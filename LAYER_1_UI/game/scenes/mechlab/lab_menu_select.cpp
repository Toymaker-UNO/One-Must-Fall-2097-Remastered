...
void lab_menu_select_choose(component *c, void *userdata) {
    lab_menu_select_t *sel = (lab_menu_select_t *)userdata;
    sel->cb(c, sel->data);
...
void lab_menu_focus_left(component *c, bool focused, void *userdata) {
    if(focused) {
        ...
        lab_menu_select_t *left = (lab_menu_select_t *)userdata;
...
void lab_menu_focus_right(component *c, bool focused, void *userdata) {
    if(focused) {
        component_disable(c, 1);
        lab_menu_select_t *right = (lab_menu_select_t *)userdata;
...
component *lab_menu_select_create(scene *s, lab_menu_select_cb select, void *selectdata, lab_menu_select_cb left,
    ...
    lab_menu_select_t *selector = (lab_menu_select_t *)calloc(1, sizeof(lab_menu_select_t));
    selector->cb = select;
    ...
    lab_menu_select_t *goleft = (lab_menu_select_t *)calloc(1, sizeof(lab_menu_select_t));
    goleft->cb = left;
    ...
    lab_menu_select_t *goright = (lab_menu_select_t *)calloc(1, sizeof(lab_menu_select_t));
    goright->cb = right;
