...
void menu_audio_done(component *c, void *userdata) {
    audio_menu_data *local = (audio_menu_data *)userdata;
...
void menu_audio_free(component *c) {
    audio_menu_data *local = (audio_menu_data *)menu_get_userdata(c);
    omf_free(local);
...
component *menu_audio_create(scene *s) {
    // Menu userdata
    audio_menu_data *local = (audio_menu_data *)calloc(1, sizeof(audio_menu_data));
