...
void sprite_play(sd_af_file *af, sd_bk_file *bk, int scale, int anim, int sprite) {
    ...
    printf("Controls: Arrow keys to navigate, SPACE to toggle auto-play, ESC to exit\n");
    ...
    // Animation variables
    int auto_play = 1; // Start with auto-play enabled
    Uint32 last_frame_time = 0;
    Uint32 frame_delay = 100; // 100ms per frame (10 FPS)
